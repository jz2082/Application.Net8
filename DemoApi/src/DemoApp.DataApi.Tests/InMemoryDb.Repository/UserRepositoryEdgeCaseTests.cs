...
public class UserRepositoryEdgeCaseTests
{
    ...
    [Fact]
    public async Task GetAllAsync_ReturnsEmpty_WhenDbIsEmpty()
    {
        var dbName = Guid.NewGuid().ToString();
        using var context = GetDbContext(dbName);
        var repo = GetRepository(context);
    ...
    [Fact]
    public async Task GetByUsernameAndPasswordAsync_ReturnsNull_WhenUserDoesNotExist()
    {
        var dbName = Guid.NewGuid().ToString();
        using var context = GetDbContext(dbName);
        var repo = GetRepository(context);
