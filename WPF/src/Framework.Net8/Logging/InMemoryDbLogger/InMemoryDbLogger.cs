...
public class InMemoryDbLogger : ILogger
{
    ...
    public InMemoryDbLogger(string name, InMemoryDbLoggerOptions options, InMemoryLoggerDbContext loggerDbContext)
    {
        _name = name;
        _options = options;
    ...
    public void Log<TState>(LogLevel logLevel, EventId eventId, TState state, Exception exception, Func<TState, Exception, string> formatter)
    {
        ...
        {
            _loggerDbContext.LoggerInfos.Add(loggerInfo);
    ...
    public InMemoryDbLogger UsingAppLoggerFormatter(Func<object, Exception, string> formatter)
    {
